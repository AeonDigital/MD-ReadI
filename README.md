...
**Writing Tips**  
With the aim of providing a simple guide on how to write texts and articles that
are more easily internalized by humans—and also to offer AIs an 'information architecture'
for text generation—we present some [writing tips](docs/WRITING_TIPS.md) that we
believe will be useful to writers across all fields.
